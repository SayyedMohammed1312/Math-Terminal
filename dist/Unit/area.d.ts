declare function __Area_of_Square(side: number): number;
/**
 ...
 */
declare function __Area_of_rectangle(l: number, b: number): number;
declare function __Area_of_parallelogram(Base: number, height: number): number;
declare function __Area_of_triangle(Base: number, height: number): number;
